...
public class beauty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.beauty);
        ...
        Adpbeauty Adpbeauty = new Adpbeauty(beauty.this,firstName);
        recyclerView.setAdapter(Adpbeauty);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class Adpbeauty extends RecyclerView.Adapter<Adpbeauty.MyViewHolder> {
    String data[];
    Context context;
    public Adpbeauty(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
