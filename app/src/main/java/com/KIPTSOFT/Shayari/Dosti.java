...
public class Dosti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.dosti);
        ...
        AdpDosti AdpDosti = new AdpDosti(Dosti.this,firstName);
        recyclerView.setAdapter(AdpDosti);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpDosti extends RecyclerView.Adapter<AdpDosti.MyViewHolder> {
    String data[];
    Context context;
    public AdpDosti(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
