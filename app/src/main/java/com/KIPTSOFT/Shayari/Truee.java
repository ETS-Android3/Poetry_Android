...
public class Truee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_truee);
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.tru);
        ...
        AdpTruee AdpTruee = new AdpTruee(Truee.this,firstName);
        recyclerView.setAdapter(AdpTruee);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpTruee extends RecyclerView.Adapter<AdpTruee.MyViewHolder> {
    String data[];
    Context context;
    public AdpTruee(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
