...
public class Yaad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yaad);
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.yaad);
        ...
        AdpYaad AdpYaad = new AdpYaad(Yaad.this,firstName);
        recyclerView.setAdapter(AdpYaad);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpYaad extends RecyclerView.Adapter<AdpYaad.MyViewHolder> {
    String data[];
    Context context;
    public AdpYaad(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
