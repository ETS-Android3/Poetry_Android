...
public class Romantic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.romantic);
        ...
        AdpRomantic AdpRomantic = new AdpRomantic(Romantic.this,firstName);
        recyclerView.setAdapter(AdpRomantic);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpRomantic extends RecyclerView.Adapter<AdpRomantic.MyViewHolder> {
    String data[];
    Context context;
    public AdpRomantic(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
