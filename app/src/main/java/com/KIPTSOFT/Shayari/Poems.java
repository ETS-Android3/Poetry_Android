...
public class Poems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.poems);
        ...
        AdpPoems AdpPoems = new AdpPoems(Poems.this,firstName);
        recyclerView.setAdapter(AdpPoems);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpPoems extends RecyclerView.Adapter<AdpPoems.MyViewHolder> {
    String[] data;
    Context context;
    public AdpPoems(Context c1,String[] s1)
    {
        context = c1;
        data = s1;
    }
