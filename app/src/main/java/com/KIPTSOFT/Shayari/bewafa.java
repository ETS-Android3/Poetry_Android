...
public class bewafa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.bewafa);
        ...
        MyAdp myAdp = new MyAdp(bewafa.this,firstName);
        recyclerView.setAdapter(myAdp);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class MyAdp extends RecyclerView.Adapter<MyAdp.MyViewHolder> {
    String data[];
    Context context;
    public MyAdp(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
