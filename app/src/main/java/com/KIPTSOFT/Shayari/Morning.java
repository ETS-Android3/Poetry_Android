...
public class Morning extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.morning);
        ...
        AdpMorning AdpMorning = new AdpMorning(Morning.this,firstName);
        recyclerView.setAdapter(AdpMorning);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpMorning extends RecyclerView.Adapter<AdpMorning.MyViewHolder> {
    String data[];
    Context context;
    public AdpMorning(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
