...
public class RandomS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_random_s);
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.randomestatus);
        ...
        AdpRandomS AdpRandomS = new AdpRandomS(RandomS.this,firstName);
        recyclerView.setAdapter(AdpRandomS);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpRandomS extends RecyclerView.Adapter<AdpRandomS.MyViewHolder> {
    String data[];
    Context context;
    public AdpRandomS(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
