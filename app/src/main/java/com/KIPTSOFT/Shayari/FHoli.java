...
public class FHoli extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_f_holi);
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.festival);
        ...
        AdpFHoli AdpFHoli = new AdpFHoli(FHoli.this,firstName);
        recyclerView.setAdapter(AdpFHoli);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpFHoli extends RecyclerView.Adapter<AdpFHoli.MyViewHolder> {
    String data[];
    Context context;
    public AdpFHoli(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
