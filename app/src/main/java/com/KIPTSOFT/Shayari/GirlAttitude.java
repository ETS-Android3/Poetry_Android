...
public class GirlAttitude extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_girl_attitude);
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.girlattitude);
        ...
        AdpGirlAttitude AdpGirlAttitude = new AdpGirlAttitude(GirlAttitude.this,firstName);
        recyclerView.setAdapter(AdpGirlAttitude);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpGirlAttitude extends RecyclerView.Adapter<AdpGirlAttitude.MyViewHolder> {
    String data[];
    Context context;
    public AdpGirlAttitude(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
