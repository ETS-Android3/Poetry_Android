...
public class Love extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.Love);
        ...
        AdpLove AdpLove = new AdpLove(Love.this,firstName);
        recyclerView.setAdapter(AdpLove);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpLove extends RecyclerView.Adapter<AdpLove.MyViewHolder> {
    String data[];
    Context context;
    public AdpLove(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
