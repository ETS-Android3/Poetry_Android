...
public class Funny extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.funny);
        ...
        AdpFunny AdpFunny = new AdpFunny(Funny.this,firstName);
        recyclerView.setAdapter(AdpFunny);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpFunny extends RecyclerView.Adapter<AdpFunny.MyViewHolder> {
    String data[];
    Context context;
    public AdpFunny(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
