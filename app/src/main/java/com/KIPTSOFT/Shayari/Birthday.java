...
public class Birthday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.birthday);
        ...
        AdpBirthday AdpBirthday = new AdpBirthday(Birthday.this,firstName);
        recyclerView.setAdapter(AdpBirthday);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpBirthday extends RecyclerView.Adapter<AdpBirthday.MyViewHolder> {
    String data[];
    Context context;
    public AdpBirthday(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
