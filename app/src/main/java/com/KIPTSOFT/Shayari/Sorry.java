...
public class Sorry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.sorry);
        ...
        AdpSorry AdpSorry = new AdpSorry(Sorry.this,firstName);
        recyclerView.setAdapter(AdpSorry);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpSorry extends RecyclerView.Adapter<AdpSorry.MyViewHolder> {
    String data[];
    Context context;
    public AdpSorry(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
