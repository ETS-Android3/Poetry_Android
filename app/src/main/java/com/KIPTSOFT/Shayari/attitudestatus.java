...
public class attitudestatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.attitudestatus);
        ...
        Adpattitudestatus Adpattitudestatus = new Adpattitudestatus(attitudestatus.this,firstName);
        recyclerView.setAdapter(Adpattitudestatus);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class Adpattitudestatus extends RecyclerView.Adapter<Adpattitudestatus.MyViewHolder> {
    String data[];
    Context context;
    public Adpattitudestatus(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
