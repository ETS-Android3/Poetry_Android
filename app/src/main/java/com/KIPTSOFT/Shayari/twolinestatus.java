...
public class twolinestatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twolinestatus);
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        // MobileAds.initialize(this,"ca-app-pub-5449642119113086/2591260660");
        ...
        s1 = getResources().getStringArray(R.array.twolinestatus);
        ...
        Adptwolinestatus Adptwolinestatus = new Adptwolinestatus(twolinestatus.this, firstName);
        recyclerView.setAdapter(Adptwolinestatus);
...
class Adptwolinestatus extends RecyclerView.Adapter<Adptwolinestatus.MyViewHolder> {
    String data[];
    Context context;

    public Adptwolinestatus(Context c1, String s1[]) {
        context = c1;
        data = s1;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
       ...
       /* holder.textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                holder.textView.setTypeface( ResourcesCompat.getFont( context, R.font.satisfy));
            }
        });*/
