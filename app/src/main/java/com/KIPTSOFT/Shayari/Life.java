...
public class Life extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.life);
        ...
        AdpLife AdpLife = new AdpLife(Life.this,firstName);
        recyclerView.setAdapter(AdpLife);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpLife extends RecyclerView.Adapter<AdpLife.MyViewHolder> {
    String data[];
    Context context;
    public AdpLife(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
