...
public class Desh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.desh);
        ...
        AdpDesh AdpDesh = new AdpDesh(Desh.this,firstName);
        recyclerView.setAdapter(AdpDesh);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpDesh extends RecyclerView.Adapter<AdpDesh.MyViewHolder> {
    String data[];
    Context context;
    public AdpDesh(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
