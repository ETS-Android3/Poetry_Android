...
public class Sharabi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.sharabi);
        ...
        AdpSharabi AdpSharabi = new AdpSharabi(Sharabi.this,firstName);
        recyclerView.setAdapter(AdpSharabi);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpSharabi extends RecyclerView.Adapter<AdpSharabi.MyViewHolder> {
    String data[];
    Context context;
    public AdpSharabi(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
