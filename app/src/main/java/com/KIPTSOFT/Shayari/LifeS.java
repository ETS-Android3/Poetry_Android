...
public class LifeS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_life_s);
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.lifeestatus);
        ...
        AdpLifeS AdpLifeS = new AdpLifeS(LifeS.this,firstName);
        recyclerView.setAdapter(AdpLifeS);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpLifeS extends RecyclerView.Adapter<AdpLifeS.MyViewHolder> {
    String data[];
    Context context;
    public AdpLifeS(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
