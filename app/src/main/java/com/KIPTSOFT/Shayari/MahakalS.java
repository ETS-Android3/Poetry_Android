...
public class MahakalS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mahakal_s);
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.mahastatus);
        ...
        AdpMahakalS AdpMahakalS = new AdpMahakalS(MahakalS.this,firstName);
        recyclerView.setAdapter(AdpMahakalS);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpMahakalS extends RecyclerView.Adapter<AdpMahakalS.MyViewHolder> {
    String data[];
    Context context;
    public AdpMahakalS(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
