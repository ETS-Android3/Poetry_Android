...
public class Funnystatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.funnystatus);
        ...
        AdpFunnystatus AdpFunnystatus = new AdpFunnystatus(Funnystatus.this,firstName);
        recyclerView.setAdapter(AdpFunnystatus);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpFunnystatus extends RecyclerView.Adapter<AdpFunnystatus.MyViewHolder> {
    String data[];
    Context context;
    public AdpFunnystatus(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
