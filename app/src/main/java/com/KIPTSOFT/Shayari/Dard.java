...
public class Dard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.dard);
        ...
        AdpDard AdpDard = new AdpDard(Dard.this, firstName);
        recyclerView.setAdapter(AdpDard);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}

class AdpDard extends RecyclerView.Adapter<AdpDard.MyViewHolder> {
    String data[];
    Context context;

    public AdpDard(Context c1, String s1[]) {
        context = c1;
        data = s1;
    }
