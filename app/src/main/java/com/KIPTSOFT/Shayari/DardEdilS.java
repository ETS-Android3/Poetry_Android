...
public class DardEdilS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dard_edil_s);
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.darededillestatus);
        ...
        AdpDardEdilS AdpDardEdilS = new AdpDardEdilS(DardEdilS.this,firstName);
        recyclerView.setAdapter(AdpDardEdilS);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpDardEdilS extends RecyclerView.Adapter<AdpDardEdilS.MyViewHolder> {
    String data[];
    Context context;
    public AdpDardEdilS(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
