...
public class Night extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.night);
        ...
        AdpNight AdpNight = new AdpNight(Night.this,firstName);
        recyclerView.setAdapter(AdpNight);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpNight extends RecyclerView.Adapter<AdpNight.MyViewHolder> {
    String data[];
    Context context;
    public AdpNight(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
