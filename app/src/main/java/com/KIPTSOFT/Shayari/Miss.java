...
public class Miss extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.miss);
        ...
        AdpMiss AdpMiss = new AdpMiss(Miss.this,firstName);
        recyclerView.setAdapter(AdpMiss);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpMiss extends RecyclerView.Adapter<AdpMiss.MyViewHolder> {
    String data[];
    Context context;
    public AdpMiss(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
