...
public class attitude extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.attitude);
        ...
        Adpattitude Adpattitude = new Adpattitude(attitude.this, firstName);
        recyclerView.setAdapter(Adpattitude);
...
class Adpattitude extends RecyclerView.Adapter<Adpattitude.MyViewHolder> {
    String data[];
    Context context;

    public Adpattitude(Context c1, String s1[]) {
        context = c1;
        data = s1;
    }
