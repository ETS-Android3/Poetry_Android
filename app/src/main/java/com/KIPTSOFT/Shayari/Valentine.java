...
public class Valentine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* RecyclerView constraintLayout = findViewById(R.id.r1);
        ...
        s1 = getResources().getStringArray(R.array.valentine);
        ...
        AdpValentine AdpValentine = new AdpValentine(Valentine.this,firstName);
        recyclerView.setAdapter(AdpValentine);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

    }
}
class AdpValentine extends RecyclerView.Adapter<AdpValentine.MyViewHolder> {
    String data[];
    Context context;
    public AdpValentine(Context c1,String s1[])
    {
        context = c1;
        data = s1;
    }
